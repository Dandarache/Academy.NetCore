...
namespace EntityFrameworkChinook
{
    public partial class ChinookContext : DbContext
    {
        ...
        // Unable to generate entity type for table 'dbo.Faa'. Please see the warning messages.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Manufacturers>(entity =>
            {
                entity.HasKey(e => e.Code)
                    .HasName("PK__Manufact__A25C5AA60429198B");
            ...
            {
                entity.HasKey(e => e.Code)
                    .HasName("PK__Products__A25C5AA629EA8A68");
                ...
                entity.HasOne(d => d.ManufacturerNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Products__Manufa__7C4F7684");
            });
