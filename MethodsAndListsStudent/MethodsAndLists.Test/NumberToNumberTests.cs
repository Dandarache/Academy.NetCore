...
namespace MethodsAndLists.Test
{
    ...
    public class NumberToNumberTests
    {
        ...
        public void SumNumbersTo(int expected, int input)
        {
            ...
            Assert.AreEqual(expected, x.SumNumbersTo_Recursion(input));
            Assert.AreEqual(expected, x.SumNumbersTo_OneLineOfCode(input));
            Assert.AreEqual(expected, x.SumNumbersTo_WithoutLinq(input));
        }
        ...
        public void SumNumbersTo_InvalidInput(int input)
        {
            ...
            Assert.ThrowsException<ArgumentException>(() => x.SumNumbersTo_Recursion(input));
            Assert.ThrowsException<ArgumentException>(() => x.SumNumbersTo_OneLineOfCode(input));
            Assert.ThrowsException<ArgumentException>(() => x.SumNumbersTo_WithoutLinq(input));
        }
